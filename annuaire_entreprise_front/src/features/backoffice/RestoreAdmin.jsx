...
const RestoreAdmin = ({ isOpen, onClose, onConfirm }) => {
      ...
      <div className="bg-white rounded-lg shadow-lg w-11/12 sm:w-96">
        ...
        <div className="p-4 text-center">
          <p className="text-gray-700">
            Voulez-vous vraiment restaurer cet administrateur ?
          </p>
        </div>
        ...
        <div className="flex justify-between mt-4 p-2">
          ...
          <button
            onClick={onConfirm}
            className="w-1/2 py-2 ml-2 cursor-pointer bg-green-500 text-white rounded-lg hover:bg-green-600 transition"
          >
            Restaurer
          </button>
        </div>
